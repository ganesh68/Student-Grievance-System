...
<body style="background-color:blue">
    ...
    <marquee direction="right"><span style="background-color:yellow"><font color="red" size="5"><b>University exams will be organised through online media.</b></font></span></marquee>
    <div class="register-photo" style="background-color: rgba(255,255,255,0.00);">
        <div class="form-container">
            <div class="image-holder"></div><form method="post">
    <h2 class="text-center"><strong>Students Log In</strong></h2>
